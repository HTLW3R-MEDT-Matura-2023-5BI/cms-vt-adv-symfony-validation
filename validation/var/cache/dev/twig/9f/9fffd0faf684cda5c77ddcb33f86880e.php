...
class __TwigTemplate_2864f0117248ae761589e3edcff5fe02 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_movie_delete', {'id': movie.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">

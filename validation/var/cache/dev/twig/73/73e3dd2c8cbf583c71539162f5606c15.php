...
{% block body %}
    ...
    <div class=\"mb-3\">
    Already registered? <a href=\"{{ path('app_login') }}\" class=\"text-decoration-none\"> Login</a>
    </div>
    <button type=\"submit\" class=\"btn btn-primary\">Register</button>
    {{ form_end(registrationForm) }}
{% endblock %}
", "registration/register.html.twig", "/Users/alex/Schule/5bi-2022-23/Medientechnik/Content Management Systeme - Vertiefung/SymfonyORM/templates/registration/register.html.twig");
    }
}
